...
解压文件后将hugo移动到制定目录/opt/script/run/hugo,同时配置环境变量export PATH="/opt/script/run:$PATH"
...
## 5 添加主题 
git clone https://github.com/chavinking/hugo-theme-even.git themes/even 

## 6 创建文章 
hugo new post/other/基于MacM1处理器的github博客搭建.md

## 7 启动服务 
hugo server --port 9999 
...
git add * 
git commit -m "commit blog"
git remote add origin https://github.com/chavinking/chavinking.github.io.git
git push -f origin master 

## 10 配置文件 
```text 
baseURL = "https://chavinking.github.io/"
languageCode = "zh-CN"
...
paginate = 20                                              # 首页每页显示的文章数
disqusShortname = ""      # disqus_shortname
googleAnalytics = "UA-138883536-1"      # UA-XXXXXXXX-X
...
[params]
  ...
  gitRepo = "https://github.com/chavinking"

  # site info (optional)                                  # 站点信息（可选，不需要的可以直接注释掉）
  logoTitle = ""        # default: the title value    # 默认值: 上面设置的title值
  keywords = ["data warehouse", "Github" ,"flink", "java","spark","ETL"]
  description = "ChavinKing's Blog"
  ...
  # Syntax highlighting by highlight.js 设置false,否则代码块靠右侧显示 
  ...
  [params.outdatedInfoWarning]
    enable = false 
    hint = 365               # Display hint if the last modified time is more than these days ago.    # 如果文章最后更新于这天数之前，显示提醒
    warn = 730             # Display warning if the last modified time is more than these days ago.    # 如果文章最后更新于这天数之前，显示警告

  [params.utterances]           # https://github.com/utterance/utterances 评论插件
    repo = ""               # 安装 https://github.com/apps/utterances  ,配置选择的 github 仓库，，仓库名字要一致
  ...
  [params.reward]                         # 文章打赏
    enable = true
    wechat = "/images/wx.png"             # 微信二维码
    alipay = "/images/zfb.png"            # 支付宝二维码

  [params.social] # 社交链接
    g-email = "mailto:chavinking1990@gmail.com"
    g-github = "https://github.com/chavinking"
    g-cnblogs = "http://www.cnblogs.com/wcwen1990"
